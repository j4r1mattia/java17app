...
public class CourseRetrievalService {
  ...
  public List<PluralsightCourse> getCoursesFor(String author) {
    HttpRequest request = HttpRequest.newBuilder(URI.create(PS_URL.formatted(author)))
        .GET()
        .build();
  ...
  private List<PluralsightCourse> getPluralsightCourses(HttpResponse<String> response)
      throws JsonProcessingException, JsonMappingException {
    JavaType returnType = OBJECT_MAPPER.getTypeFactory().constructCollectionType(List.class,
